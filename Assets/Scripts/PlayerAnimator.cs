...
public class PlayerAnimator : CharacterAnimator
{
    ...
    void OnEquipmentChanged(Equipment newItem, Equipment oldItem)
    {
        ...
        {
            animator.SetLayerWeight(1/*Layer Index*/, 1);
